...
<head>
  ...
  <title>Kiyowoz - <?php echo $hlm?></title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="<?php echo base_url()?>public/NiceAdmin/assets/img/logo1.png" rel="icon" >
...
<body>
  ...
  <!-- untuk menampilkan source javascript yang berasal dari file content -->
