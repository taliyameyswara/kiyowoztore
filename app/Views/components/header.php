...
<img src="<?php echo base_url() ?>public/NiceAdmin/assets/img/logo1.png" width="40px">
  <a href="index.html" class="logo d-flex align-items-center">
    <span class="d-none d-lg-block ms-1">KiyowoStore</span>
  </a>
  ...
  <ul class="d-flex align-items-center">
    ...
    <li class="nav-item dropdown pe-3">
      ...
      <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
        ...
        <li>
          <a class="dropdown-item d-flex align-items-center <?php echo (uri_string()=='profile')?>" href="<?php echo base_url()?>profile">
